		...
		if(in_array($file_extension, $valid_extension)) {
			if(move_uploaded_file(
				...
				$target_file)
                    ...
                    $sql = "INSERT INTO `coachs`(  `first_name`, `last_name`, `img`, 
                    `birth_date`, `category`, `mission`, `sex`) VALUES 
					(  '$first_name', '$last_name',
					'$target_file', '$birth_date', '$category', '$mission', '$sex')";
					
				
					
                    // use exec() because no results are returned
                    $DB_con->exec($sql);
                    $succes= "Nouvelle coachs créée avec succès";
